...
# Estilos CSS mejorados + FONDO DE IMAGEN SUTIL
st.markdown("""
<style>
    /* Fondo de imagen de física, desaturado y con opacidad baja */
    .stApp {
        background-image: url("https://i.imgur.com/3fRZVqk.png");
        background-size: cover;
        background-position: center;
        background-attachment: fixed;
        background-color: rgba(255, 255, 255, 0.9); /* Capa blanca semitransparente para reducir contraste */
